            ...
            <div class="d-flex align-items-center">
                                        ...
                                        <div class="d-flex">
                                            ...
                                            <div class="flex-grow-1">
                                                ...
                                                <p class="mb-1 fs-12 text-muted">
                                                    Confidence: <span class="badge bg-<?php echo e($confidence >= 0.8 ? 'success' : ($confidence >= 0.6 ? 'warning' : 'danger')); ?>">
                                                        <?php echo e(round($confidence * 100)); ?>%
                                                    </span>
                                                </p>
                ...
                <div class="dropdown ms-sm-3 header-item topbar-user">
                    ...
                    <div class="dropdown-menu dropdown-menu-end">
                        ...
                        <a class="dropdown-item" href="<?php echo e(route('management.tasks.kanban.index')); ?>"><i class="mdi mdi-calendar-check-outline text-muted fs-16 align-middle me-1"></i> <span class="align-middle">Taskboard</span></a>
