                ...
                <div class="card-body">
                    ...
                    <div class="mt-3">
                        <div class="d-flex justify-content-center align-items-center mb-4">
                            <h2 class="me-3 ff-secondary mb-0">{{ $projectsStatus['total'] }}</h2>
                            <div>
                                <p class="text-muted mb-0">Total Projects</p>
                                <p class="text-success fw-medium mb-0">
                                    <span class="badge bg-success-subtle text-success p-1 rounded-circle"><i
                                            class="ri-arrow-right-up-line"></i></span> +{{ $projectsStatus['new_this_month'] }} New
                                </p>
                            </div>
                        </div>
                        ...
                        <div
                            ...
                            <p class="fw-medium mb-0"><i
                                ...
                                Completed</p>
                            <div>
                                <span class="text-muted pe-5">{{ $projectsStatus['completed'] }} Projects</span>
                                <span class="text-success fw-medium fs-12">{{ $projectsStatus['completed_hours'] }}hrs</span>
                            </div>
                        </div><!-- end -->
                        <div
                            class="d-flex justify-content-between border-bottom border-bottom-dashed py-2">
                            <p class="fw-medium mb-0"><i
                                ...
                                In Progress</p>
                            <div>
                                <span class="text-muted pe-5">{{ $projectsStatus['in_progress'] }} Projects</span>
                                <span class="text-success fw-medium fs-12">{{ $projectsStatus['in_progress_hours'] }}hrs</span>
                            </div>
                        </div><!-- end -->
                        <div
                            class="d-flex justify-content-between border-bottom border-bottom-dashed py-2">
                            <p class="fw-medium mb-0"><i
                                ...
                                Yet to Start</p>
                            <div>
                                <span class="text-muted pe-5">{{ $projectsStatus['yet_to_start'] }} Projects</span>
                                <span class="text-muted fw-medium fs-12">{{ $projectsStatus['yet_to_start_hours'] > 0 ? $projectsStatus['yet_to_start_hours'] . 'hrs' : '~0hrs' }}</span>
                            </div>
                        </div><!-- end -->
                        <div class="d-flex justify-content-between py-2">
                            <p class="fw-medium mb-0"><i
                                ...
                                Cancelled</p>
                            <div>
                                <span class="text-muted pe-5">{{ $projectsStatus['cancelled'] }} Projects</span>
                                <span class="text-muted fw-medium fs-12">{{ $projectsStatus['cancelled_hours'] > 0 ? $projectsStatus['cancelled_hours'] . 'hrs' : '~0hrs' }}</span>
                            </div>
                        </div><!-- end -->
                    </div>
                </div><!-- end cardbody -->
            ...
            <div class="card card-height-100">
                <div class="card-header align-items-center d-flex">
                    ...
                    <div class="flex-shrink-0">
                        <span class="badge bg-info-subtle text-info">{{ $aiStatistics['avg_confidence'] }}% Confidence</span>
                    </div>
                </div><!-- end card header -->
                ...
                <div class="card-body">
                    ...
                    <div class="mt-3">
                        <div class="d-flex justify-content-center align-items-center mb-4">
                            <h2 class="me-3 ff-secondary mb-0">{{ $aiStatistics['total'] }}</h2>
                            <div>
                                <p class="text-muted mb-0">Total AI Decisions</p>
                                <p class="text-success fw-medium mb-0">
                                    <span class="badge bg-success-subtle text-success p-1 rounded-circle"><i
                                            class="ri-arrow-right-up-line"></i></span> +{{ $aiStatistics['new_this_month'] }} This Month
                                </p>
                            </div>
                        </div>
                        ...
                        <div
                            ...
                            <p class="fw-medium mb-0"><i
                                ...
                                Pending</p>
                            <div>
                                <span class="text-muted pe-5">{{ $aiStatistics['pending'] }} Decisions</span>
                                <span class="text-muted fw-medium fs-12">{{ round(($aiStatistics['total'] > 0 ? $aiStatistics['pending'] / $aiStatistics['total'] : 0) * 100, 1) }}%</span>
                            </div>
                        </div><!-- end -->
                        <div
                            class="d-flex justify-content-between border-bottom border-bottom-dashed py-2">
                            <p class="fw-medium mb-0"><i
                                ...
                                Accepted</p>
                            <div>
                                <span class="text-muted pe-5">{{ $aiStatistics['accepted'] }} Decisions</span>
                                <span class="text-success fw-medium fs-12">{{ $aiStatistics['acceptance_rate'] }}%</span>
                            </div>
                        </div><!-- end -->
                        <div
                            class="d-flex justify-content-between border-bottom border-bottom-dashed py-2">
                            <p class="fw-medium mb-0"><i
                                ...
                                Rejected</p>
                            <div>
                                <span class="text-muted pe-5">{{ $aiStatistics['rejected'] }} Decisions</span>
                                <span class="text-danger fw-medium fs-12">{{ round((($aiStatistics['accepted'] + $aiStatistics['rejected']) > 0 ? $aiStatistics['rejected'] / ($aiStatistics['accepted'] + $aiStatistics['rejected']) : 0) * 100, 1) }}%</span>
                            </div>
                        </div><!-- end -->
                        <div class="d-flex justify-content-between py-2">
                            <p class="fw-medium mb-0"><i
                                ...
                                Avg Confidence</p>
                            <div>
                                <span class="text-primary fw-medium">{{ $aiStatistics['avg_confidence'] }}%</span>
                            </div>
                        </div><!-- end -->
                    </div>
                </div><!-- end cardbody -->
    ...
    document.addEventListener('DOMContentLoaded', function() {
        setTimeout(function() {
            ...
            if (aiChartEl) {
                ...
                if (aiChartColors) {
                    var aiData = {
                        pending: {{ $aiStatistics['pending'] }},
                        accepted: {{ $aiStatistics['accepted'] }},
                        rejected: {{ $aiStatistics['rejected'] }},
                        modified: {{ $aiStatistics['total'] - $aiStatistics['pending'] - $aiStatistics['accepted'] - $aiStatistics['rejected'] }}
                    };
        ...
        setTimeout(function() {
            ...
            if (projectsChartEl) {
                ...
                if (projectsChartColors) {
                    var projectsData = {
                        completed: {{ $projectsStatus['completed'] }},
                        in_progress: {{ $projectsStatus['in_progress'] }},
                        yet_to_start: {{ $projectsStatus['yet_to_start'] }},
                        cancelled: {{ $projectsStatus['cancelled'] }}
                    };
